...
.metadata/.plugins/org.eclipse.cdt.make.core/%.o: ../.metadata/.plugins/org.eclipse.cdt.make.core/%.c
	...
	gcc -I"/home/chiheb/ProjectCPP/DistributedStateSpace/src/DSS" -I"/home/chiheb/ProjectCPP/DistributedStateSpace/src/include" -I"/home/chiheb/ProjectCPP/DistributedStateSpace/src/src" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
